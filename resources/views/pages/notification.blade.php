...
<div class="content-scroll">
  <section class="transactions-box" style="padding-bottom: 2rem;">
    ...
    <ul>
      <li>
        <div class="icon-circle"><img src="{{ asset('assets/images/icon/money.svg') }}" alt="Transaction"></div>
        <div class="transaction-info">
    ...
    <ul>
      <li>
        <div class="icon-circle"><img src="{{ asset('assets/images/icon/expense record.svg') }}" alt="Expense Record"></div>
        <div class="transaction-info">
